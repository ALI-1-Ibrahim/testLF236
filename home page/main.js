...
const starCountRef3 = ref(db2, '/' + MYID + '/tokens');
...
//  style: 'mapbox://styles/mapbox/streets-v12', // style URL
 center: [4.8958791452777914, 52.357253879494685], // starting position [lng, lat][32.276847, 30.606981]
...
function reveal_pho() {
  ...
  if (cur>0) {
    const updates = {};
  updates[`/${MYID}/tokens`] = increment(-5);
